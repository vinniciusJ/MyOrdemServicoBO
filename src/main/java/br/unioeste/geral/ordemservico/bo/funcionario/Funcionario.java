package br.unioeste.geral.ordemservico.bo.funcionario;
...
public class Funcionario extends PessoaFisica implements Serializable {
    ...
    public Funcionario(String nome, String nomeSocial, EnderecoEspecifico endereco, List<Email> emails, List<Telefone> telefones, String primeiroNome, String nomeDoMeio, String ultimoNome, String cpf, Long id) {
